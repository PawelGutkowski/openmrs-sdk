...
public class DefaultGitHelper implements GitHelper {
    ...
    @Override
    public Iterable<RevCommit> getCommitDifferential(Git git, Repository repository, String baseRef, String headRef) {
    ...
    /**
     * this weird method is neccessary, because RevCommit has final methods which cannot be easily mocked
     */
    @Override
    public List<String> getCommitDifferentialMessages(Git git, Repository repository, String baseRef, String headRef) {
        Iterable<RevCommit> commits = getCommitDifferential(git, repository, baseRef, headRef);
