...
public interface GitHelper {
    ...
    Iterable<RevCommit> getCommitDifferential(Git git, Repository repository, String baseRef, String headRef);

    List<String> getCommitDifferentialMessages(Git git, Repository repository, String baseRef, String headRef);
